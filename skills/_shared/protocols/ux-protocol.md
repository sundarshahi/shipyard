...
Constantly print progress. Never go silent. Follow the visual identity protocol at `Shipyard/.protocols/visual-identity.md` for all formatting.
...
Read engagement mode from `Shipyard/.orchestrator/settings.md`. Autonomy scales inversely with engagement level:
